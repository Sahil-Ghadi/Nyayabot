      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
        {categories.map((cat, i) => (
          <motion.div
            ...
            className="group glass-panel p-6 rounded-[20px] hover:border-brand-gold/30 hover:shadow-[0_0_20px_rgba(212,175,55,0.1)] transition-all duration-300 cursor-pointer flex flex-col h-full"
          >
            ...
            <div className="flex items-center gap-2 text-sm font-medium text-brand-gold opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
